...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/webkit/BrowserFrame$DrmDownloadInfo;,
...
.field private static final DRM_MESSAGE_ERROR:I = 0x67

.field private static final DRM_MESSAGE_FINAL:I = 0x66

.field private static final DRM_MESSAGE_PROCESS:I = 0x65

.field private static final DRM_MESSAGE_START:I = 0x64
...
.field private static final MAX_DRM_DOWNLOAD_NUM:I = 0xa
...
.field static final SEND_END_INTENT_DELAY:I = 0x1a0a
...
.field private mDrmDownloadTag:[Landroid/webkit/BrowserFrame$DrmDownloadInfo;
...
.method public constructor <init>(Landroid/content/Context;Landroid/webkit/WebViewCore;Landroid/webkit/CallbackProxy;Landroid/webkit/WebSettingsClassic;Ljava/util/Map;)V
    ...
    new-array v2, v2, [Landroid/webkit/BrowserFrame$DrmDownloadInfo;

    iput-object v2, p0, Landroid/webkit/BrowserFrame;->mDrmDownloadTag:[Landroid/webkit/BrowserFrame$DrmDownloadInfo;
...
.method private drmReset(I)V
    ...
    .line 305
    iget-object v0, p0, Landroid/webkit/BrowserFrame;->mDrmDownloadTag:[Landroid/webkit/BrowserFrame$DrmDownloadInfo;

    aget-object v0, v0, p1

    iput-boolean v1, v0, Landroid/webkit/BrowserFrame$DrmDownloadInfo;->used:Z
    ...
    iput-boolean v1, v0, Landroid/webkit/BrowserFrame$DrmDownloadInfo;->cancel:Z
    ...
    iput-wide v1, v0, Landroid/webkit/BrowserFrame$DrmDownloadInfo;->downloadID:J
...
.method private findEmptyTagID()I
    .locals 2
    ...
    .line 320
    iget-object v1, p0, Landroid/webkit/BrowserFrame;->mDrmDownloadTag:[Landroid/webkit/BrowserFrame$DrmDownloadInfo;

    aget-object v1, v1, v0

    iget-boolean v1, v1, Landroid/webkit/BrowserFrame$DrmDownloadInfo;->used:Z
...
.method private findTagIDFromDownloadID(J)I
    .locals 3
    ...
    iget-wide v1, v1, Landroid/webkit/BrowserFrame$DrmDownloadInfo;->downloadID:J
...
.method private sendDrmMessage(ILjava/lang/String;JI)I
    .locals 9
    ...
    const-string v4, "[rick debug] sendDrmMessage "
    ...
    const-string v3, "[rick debug] DRM_MESSAGE_START "
    ...
    .line 1293
    invoke-direct {p0}, Landroid/webkit/BrowserFrame;->findEmptyTagID()I
    ...
    const-string v2, "[rick debug] DRM_MESSAGE_START tagID = "
    ...
    const-string v2, "[rick debug] DRM_MESSAGE_START downloadID = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p0, Landroid/webkit/BrowserFrame;->mDrmDownloadTag:[Landroid/webkit/BrowserFrame$DrmDownloadInfo;

    aget-object v2, v2, p5

    iget-wide v2, v2, Landroid/webkit/BrowserFrame$DrmDownloadInfo;->downloadID:J
    ...
    iget-wide v1, v0, Landroid/webkit/BrowserFrame$DrmDownloadInfo;->downloadID:J
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/webkit/BrowserFrame;->sendStartIntent(JLjava/lang/String;J)V
    ...
    const-string v4, "[rick debug] DRM_MESSAGE_PROCESS "
    ...
    iget-boolean v2, v2, Landroid/webkit/BrowserFrame$DrmDownloadInfo;->cancel:Z
    ...
    const-string v2, "[rick debug] DRM_MESSAGE_PROCESS Cancel"

    invoke-static {v1, v2}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 1314
    invoke-direct {p0, p5}, Landroid/webkit/BrowserFrame;->drmReset(I)V
    ...
    iget-wide v2, v0, Landroid/webkit/BrowserFrame$DrmDownloadInfo;->downloadID:J

    invoke-virtual {p0, v2, v3, p3, p4}, Landroid/webkit/BrowserFrame;->sendUpdateIntent(JJ)V
    ...
    const-string v3, "[rick debug] DRM_MESSAGE_FINAL "
    ...
    invoke-virtual {p0, v2, v3, p2}, Landroid/webkit/BrowserFrame;->sendEndIntent(JLjava/lang/String;)V
    ...
    const-string v3, "[rick debug] BrowserFrame.java, sendDrmMessage() DRM_MESSAGE_FINAL SEND_END_INTENT_DELAY"
    ...
    invoke-virtual {p0, v0, p5, v1, p2}, Landroid/webkit/BrowserFrame;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

    move-result-object v6

    .line 1332
    .local v6, endMessage:Landroid/os/Message;
    invoke-virtual {p0, v6, v7, v8}, Landroid/webkit/BrowserFrame;->sendMessageDelayed(Landroid/os/Message;J)Z

    goto/16 :goto_0

    .line 1339
    .end local v6           #endMessage:Landroid/os/Message;
    :pswitch_3
    const-string/jumbo v0, "webkit"
    ...
    const-string v3, "[rick debug] DRM_MESSAGE_PROCESS "
    ...
    invoke-virtual {p0, v2, v3, v0, v4}, Landroid/webkit/BrowserFrame;->sendErrorIntent(JILjava/lang/String;)V
...
.method public cancelDrmDownload(J)V
    ...
    .prologue
    .line 328
    invoke-direct {p0, p1, p2}, Landroid/webkit/BrowserFrame;->findTagIDFromDownloadID(J)I
    ...
    iput-boolean v2, v1, Landroid/webkit/BrowserFrame$DrmDownloadInfo;->cancel:Z
...
.method public getFileSavePath(J)Ljava/lang/String;
    .locals 11
    .parameter "contentLength"
    ...
    .line 1361
    .local v6, filesavepath:Ljava/lang/String;
    ...
    const-string v9, "entty getFileSavePath,SDCardExist"
    ...
    .line 1367
    .local v7, statSDCard:Landroid/os/StatFs;
    ...
    .end local v7           #statSDCard:Landroid/os/StatFs;
    :goto_0
    const-string/jumbo v8, "webkit"
    ...
    const-string v10, "filesavepath is:"
    ...
    .restart local v7       #statSDCard:Landroid/os/StatFs;
    :cond_0
    ...
    const-string v9, "entty getFileSavePath,SDCard not Exist"
...
.method public sendEndIntent(JLjava/lang/String;)V
    .locals 4
    .parameter "id"
    .parameter "fileName"
    ...
    const-string v3, "[rick debug] sendEndIntent "
    ...
    const-string v1, "com.zte.drm.end"
...
.method public sendErrorIntent(JILjava/lang/String;)V
    .locals 4
    .parameter "id"
    .parameter "errorCode"
    .parameter "description"
    ...
    const-string v3, "[rick debug] sendErrorIntent "
    ...
    .line 369
    .local v0, intent:Landroid/content/Intent;
    const-string v1, "com.zte.drm.error"
...
.method public sendStartIntent(JLjava/lang/String;J)V
    .locals 4
    .parameter "id"
    .parameter "url"
    .parameter "size"
    ...
    const-string v3, "[rick debug] sendStartIntent "
    ...
    .line 339
    .local v0, intent:Landroid/content/Intent;
    const-string v1, "com.zte.drm.start"
...
.method public sendUpdateIntent(JJ)V
    .locals 4
    .parameter "id"
    .parameter "size"
    ...
    const-string v3, "[rick debug] sendUpdateIntent "
    ...
    .line 359
    .local v0, intent:Landroid/content/Intent;
    const-string v1, "com.zte.drm.update"
