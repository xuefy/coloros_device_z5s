...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/Context;Z)V
    ...
    iput v3, p0, Lcom/android/server/am/ActivityStack;->mMoveTaskFlag:I
...
.method private final relaunchActivityLocked(Lcom/android/server/am/ActivityRecord;IZ)Z
    ...
    .line 4797
    .local v7, pausedApkName:Ljava/lang/String;
    new-instance v8, Landroid/content/Intent;

    const-string v0, "android.intent.action.apk.PAUSED"

    invoke-direct {v8, v0}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 4798
    .local v8, pausedIntent:Landroid/content/Intent;
    const-string v0, "FrontApkName"
    ...
    .line 4780
    .end local v7           #pausedApkName:Ljava/lang/String;
    .end local v8           #pausedIntent:Landroid/content/Intent;
    :catch_0
    move-exception v0
...
.method private sendActivityStackChangedIntent()V
    .locals 5
    ...
    const-string v3, "THREE_FINGER_SLIDE ActivityStack sendActivityStackChangedIntent begin mMoveTaskFlag = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Lcom/android/server/am/ActivityStack;->mMoveTaskFlag:I
    ...
    const-string v1, "needUpdeTaskList"
    ...
    .line 4835
    iget v1, p0, Lcom/android/server/am/ActivityStack;->mMoveTaskFlag:I
    ...
    .line 4837
    iput v4, p0, Lcom/android/server/am/ActivityStack;->mMoveTaskFlag:I
...
.method final activityPaused(Landroid/os/IBinder;Z)V
    ...
    .line 1083
    iget-object v2, v4, Lcom/android/server/am/ActivityRecord;->shortComponentName:Ljava/lang/String;

    .line 1084
    .local v2, pausedApkName:Ljava/lang/String;
    new-instance v3, Landroid/content/Intent;

    const-string v5, "android.intent.action.apk.PAUSED"

    invoke-direct {v3, v5}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1085
    .local v3, pausedIntent:Landroid/content/Intent;
    const-string v5, "FrontApkName"
    ...
    .line 1089
    .end local v2           #pausedApkName:Ljava/lang/String;
    .end local v3           #pausedIntent:Landroid/content/Intent;
    :cond_0
...
.method final activityResumed(Landroid/os/IBinder;)V
    ...
    iput-object v6, v5, Lcom/android/server/am/ActivityRecord;->icicle:Landroid/os/Bundle;

    .line 1053
    const/4 v6, 0x0

    iput-boolean v6, v5, Lcom/android/server/am/ActivityRecord;->haveState:Z
    ...
    iget-object v2, v6, Lcom/android/server/am/ActivityRecord;->realActivity:Landroid/content/ComponentName;
    ...
    invoke-virtual {v6, v1, v4}, Lcom/android/server/wm/WindowManagerService;->updatePackageChanged(Ljava/lang/String;Ljava/lang/String;)V
...
.method final realStartActivityLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ProcessRecord;ZZ)Z
    ...
    .line 762
    .local v21, resumeApkName:Ljava/lang/String;
    new-instance v22, Landroid/content/Intent;

    const-string v2, "android.intent.action.apk.RESUME"
    ...
    .line 763
    .local v22, resumeIntent:Landroid/content/Intent;
    const-string v2, "FrontApkName"
    ...
    .line 769
    .end local v21           #resumeApkName:Ljava/lang/String;
    .end local v22           #resumeIntent:Landroid/content/Intent;
    :cond_d
    const/4 v2, 0x0
    ...
    const-string v4, "THREE_FINGER_SLIDE ActivityStack realStartActivityLocked call sendApkLanuchIntent rId = "
    ...
    const-string v4, "THREE_FINGER_SLIDE ActivityStack realStartActivityLocked call sendApkLanuchIntent LastPausedId = "
    ...
    .line 784
    invoke-direct/range {p0 .. p0}, Lcom/android/server/am/ActivityStack;->sendActivityStackChangedIntent()V
...
.method final resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    const-string v4, "THREE_FINGER_SLIDE ActivityStack resumeTopActivityLocked 222 prevTaskId = "
    ...
    const-string v4, "THREE_FINGER_SLIDE ActivityStack resumeTopActivityLocked 222 nextTaskId = "
    ...
    .line 1775
    .local v24, resumeName:Ljava/lang/String;
    ...
    .line 1776
    .local v23, resumeIntent:Landroid/content/Intent;
    const-string v2, "FrontApkName"
    ...
    .line 1780
    .end local v23           #resumeIntent:Landroid/content/Intent;
    .end local v24           #resumeName:Ljava/lang/String;
    :cond_20
    const/4 v2, 0x0
...
.method public setMoveTaskFlag(I)V
    .locals 3
    .parameter "flag"
    ...
    const-string v2, "THREE_FINGER_SLIDE ActivityStack setMoveTaskFlag flag = "
    ...
    .line 4823
    iput p1, p0, Lcom/android/server/am/ActivityStack;->mMoveTaskFlag:I
