...
.field private mTimeTickReceiveTime:J
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-wide v3, p0, Lcom/android/server/AlarmManagerService;->mTimeTickReceiveTime:J
...
.method static synthetic access$700(Lcom/android/server/AlarmManagerService;)J
    .locals 2
    .parameter "x0"

    .prologue
    .line 64
    iget-wide v0, p0, Lcom/android/server/AlarmManagerService;->mTimeTickReceiveTime:J
...
.method static synthetic access$702(Lcom/android/server/AlarmManagerService;J)J
    ...
    .prologue
    .line 64
    iput-wide p1, p0, Lcom/android/server/AlarmManagerService;->mTimeTickReceiveTime:J
...
.method private addAlarmLocked(Lcom/android/server/AlarmManagerService$Alarm;)I
    ...
    invoke-static {v0, p1, v7}, Ljava/util/Collections;->binarySearch(Ljava/util/List;Ljava/lang/Object;Ljava/util/Comparator;)I
    ...
    const-string v7, "com.android.timemanager"
    ...
    const-string v8, "sys.pmanager.dqitime"
    ...
    const-string v8, "sys.pmanager.dqi"
    ...
    iput-wide v7, p1, Lcom/android/server/AlarmManagerService$Alarm;->when:J
    ...
    invoke-direct {p0, p1, v7}, Lcom/android/server/AlarmManagerService;->testLog(Lcom/android/server/AlarmManagerService$Alarm;Ljava/lang/String;)V
...
.method private setLocked(Lcom/android/server/AlarmManagerService$Alarm;)V
    ...
    const-string v2, " setLocked  mDescriptor : "
...
.method private testLog(Lcom/android/server/AlarmManagerService$Alarm;Ljava/lang/String;)V
    .locals 9
    .parameter "alarm"
    .parameter "myTag"
...
.method private triggerAlarmsLocked(Ljava/util/ArrayList;Ljava/util/ArrayList;J)V
    ...
    const-string v4, " - AlarmHandler triggerAlarmsLocked "
...
.method public setRepeating(IJJLandroid/app/PendingIntent;)V
    ...
    .line 236
    :cond_0
    const-string v9, " setRepeating: "

    invoke-static {v9}, Lcom/android/server/AlarmManagerService;->timerLog(Ljava/lang/String;)V
    ...
    .line 239
    :cond_1
    const-string v9, "  !!!take care!!!, it is a wakeup timer(type=0/2)."
    ...
    const-string v10, "  --trigger after "
    ...
    const-string v10, "  --target package = "
