...
.field private mCameraIndicatesAni:Landroid/graphics/drawable/AnimationDrawable;

.field private mCameraIv:Landroid/widget/ImageView;
...
.field private mHintCameraDrawable:Landroid/graphics/drawable/Drawable;

.field private mHintMusicDrawable:Landroid/graphics/drawable/Drawable;
...
.field private mMusicIndicatesAni:Landroid/graphics/drawable/AnimationDrawable;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mGradientPaint:Landroid/graphics/Paint;

    .line 60
    const/4 v2, 0x1

    iput-boolean v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mLeftToRight:Z

    .line 62
    const/4 v2, 0x0

    iput v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mOverScrollAmount:F
    ...
    iput-object v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mForegroundRect:Landroid/graphics/Rect;

    .line 64
    iput v3, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mForegroundAlpha:I

    .line 67
    iput-boolean v3, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mIsSmall:Z

    .line 72
    const/high16 v2, 0x3f80

    iput v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mBackgroundAlphaMultiplier:F
    ...
    iput-object v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mBackgroundRect:Landroid/graphics/Rect;

    .line 76
    iput-boolean v3, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mAnimationFlag:Z

    .line 82
    iput-boolean v3, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mWidgetLockedSmall:Z

    .line 83
    const/4 v2, -0x1

    iput v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mMaxChallengeTop:I

    .line 199
    new-instance v2, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame$1;

    invoke-direct {v2, p0}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame$1;-><init>(Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;)V

    iput-object v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mUpdateMonitorCallbacks:Lcom/android/internal/policy/impl/keyguard/KeyguardUpdateMonitorCallback;

    .line 116
    new-instance v2, Lcom/android/internal/policy/impl/keyguard/CheckLongPressHelper;

    invoke-direct {v2, p0}, Lcom/android/internal/policy/impl/keyguard/CheckLongPressHelper;-><init>(Landroid/view/View;)V

    iput-object v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mLongPressHelper:Lcom/android/internal/policy/impl/keyguard/CheckLongPressHelper;
    ...
    iput-object v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->res:Landroid/content/res/Resources;

    .line 121
    iget-object v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->res:Landroid/content/res/Resources;
    ...
    iput v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mFrameStrokeAdjustment:I
    ...
    iput v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mSmallWidgetHeight:I
    ...
    iput-object v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mBackgroundDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mGradientColor:I

    .line 133
    iget-object v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mGradientPaint:Landroid/graphics/Paint;

    sget-object v3, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->sAddBlendMode:Landroid/graphics/PorterDuffXfermode;
...
.method private clear()V
    ...
    .line 192
    :try_start_0
    iget-object v1, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mCameraIndicatesAni:Landroid/graphics/drawable/AnimationDrawable;

    if-eqz v1, :cond_0

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mCameraIndicatesAni:Landroid/graphics/drawable/AnimationDrawable;

    .line 193
    :cond_0
    iget-object v1, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mMusicIndicatesAni:Landroid/graphics/drawable/AnimationDrawable;

    if-eqz v1, :cond_1

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mMusicIndicatesAni:Landroid/graphics/drawable/AnimationDrawable;
    :try_end_0
...
# virtual methods
.method public addIndicatesView()V
    .locals 4
    ...
    .line 157
    iget-object v0, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mMusicIv:Landroid/widget/ImageView;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mMusicIndicatesAni:Landroid/graphics/drawable/AnimationDrawable;
    ...
    invoke-virtual {p0}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1}, Landroid/widget/ImageView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mMusicIv:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mMusicIndicatesAni:Landroid/graphics/drawable/AnimationDrawable;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    .line 166
    :cond_1
    iget-object v0, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mCameraIv:Landroid/widget/ImageView;

    if-eqz v0, :cond_2

    iget-object v0, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mCameraIndicatesAni:Landroid/graphics/drawable/AnimationDrawable;
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mCameraIv:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->mCameraIndicatesAni:Landroid/graphics/drawable/AnimationDrawable;
...
.method public getContentAppWidgetId()I
    ...
    .restart local v0       #content:Landroid/view/View;
    :cond_1
    instance-of v1, v0, Lcom/android/internal/policy/impl/keyguard/KeyguardNotificationView;

    if-eqz v1, :cond_2

    .line 357
    check-cast v0, Lcom/android/internal/policy/impl/keyguard/KeyguardNotificationView;

    .end local v0           #content:Landroid/view/View;
    invoke-virtual {v0}, Lcom/android/internal/policy/impl/keyguard/KeyguardNotificationView;->getAppWidgetId()I
...
.method protected onDetachedFromWindow()V
    ...
    .line 145
    invoke-direct {p0}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->clear()V
