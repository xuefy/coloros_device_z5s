...
.field private static final EVENT_GET_SPECIAL_PLMN_DONE:I = 0x22
...
.field private static final EVENT_UPDATE_SPECIAL_PLMN_DONE:I = 0x23
...
.method public getSpecialFile()[B
    .locals 1

    .prologue
    .line 1415
    iget-object v0, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mSpecialFilebytes:[B
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v4, "---plmn-----handleMessage---EVENT_GET_SPECIAL_PLMN_DONE---"
    ...
    iget-object v4, v0, Lcom/android/internal/telephony/uicc/IccRecords;->mLock:Ljava/lang/Object;
    ...
    iput-object v2, v0, Lcom/android/internal/telephony/uicc/IccRecords;->mSpecialFilebytes:[B
    ...
    invoke-direct {v0, v9}, Lcom/android/internal/telephony/uicc/SIMRecords;->notifyPending(Landroid/os/AsyncResult;)V
    ...
    iget-object v5, v0, Lcom/android/internal/telephony/uicc/IccRecords;->mSpecialFilebytes:[B
    ...
    const-string v6, "Exception in fetching EF_PLMN data "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, v9, Landroid/os/AsyncResult;->exception:Ljava/lang/Throwable;
    ...
    iget-object v2, v0, Lcom/android/internal/telephony/uicc/IccRecords;->mSpecialFilebytes:[B
    ...
    const-string v4, "---plmn------handleMessage---EVENT_UPDATE_SPECIAL_PLMN_DONE---"
    ...
    iput-boolean v2, v0, Lcom/android/internal/telephony/uicc/IccRecords;->success:Z
...
.method public requestSpecialPlmnFile()[B
    .locals 4
    ...
    const-string v1, "---plmn------requestSpecialPlmnFile------"
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mSpecialFilebytes:[B
    ...
    .line 1424
    invoke-virtual {p0}, Lcom/android/internal/telephony/uicc/SIMRecords;->waitForResult()V
...
.method public updateSpecialPlmnFile([B)Z
    .locals 5
    .parameter "data"
    ...
    const-string v1, "---plmn------updateSpecialPlmnFile------"
    ...
    :try_start_0
    iput-boolean v0, p0, Lcom/android/internal/telephony/uicc/IccRecords;->success:Z
    ...
    invoke-virtual {v0, v2, p1, v3}, Lcom/android/internal/telephony/uicc/IccFileHandler;->updateEFTransparent(I[BLandroid/os/Message;)V
    ...
    .line 1438
    iget-boolean v0, p0, Lcom/android/internal/telephony/uicc/IccRecords;->success:Z
...
.method protected waitForResult()V
    ...
    const-string v2, "waitForResult interrupted while trying to update by updateSpecialPlmnFile"
