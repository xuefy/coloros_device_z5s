...
DIR=`pwd`
FILE="app/SystemUI.apk app/Phone.apk framework/android.policy.jar framework/pm.jar framework/telephony-common.jar framework/services.jar framework/framework.jar"
